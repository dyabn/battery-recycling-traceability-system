...
| 编号 | 类型 | 来源 | 状态 |
| --- | --- | --- | --- |
| BIZ-C3-SLICE-001 | 第一条业务切片 | `docs/business/c3-first-business-slice.md` | 待评审 |
| UC-C3-001..010 | 用例 | C3 第一条业务切片定义 | 待评审 |
| AC-001..014 | 验收标准 | C3 第一条业务切片定义 | 待评审 |
| BSR-C3-001..010 | 业务切片需求 | C3 追踪矩阵 | 待评审 |
| Q-C3-001..005 | 开放问题 | C3 待确认问题 | open |
...
| BSR-C3-010 已生效记录保护和更正追溯 | BR-005、BR-014、BR-044、BR-045、EX-013 | AC-014 | UC-C3-010 |
