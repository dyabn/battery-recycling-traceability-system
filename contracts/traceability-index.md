...
| 编号 | 类型 | 来源 | 状态 |
| --- | --- | --- | --- |
| C4-REQ-001 | 系统需求规格 | `docs/requirements/c4-first-slice-system-requirements.md` | 待评审 |
| UR-C4-001..010 | 用户需求 | C4 第一切片系统需求规格 | 待评审 |
| FR-C4-001..022 | 功能需求 | C4 第一切片系统需求规格 | 待评审 |
| NFR-C4-001..005 | 非功能需求 | C4 第一切片系统需求规格 | 待评审 |
| Q-C3-001..003 | C4 后移问题处理 | C4 第一切片系统需求规格第 10 节 | 待评审 |
| C4-TEST-001 | 测试设计 | `docs/testing/c4-first-slice-test-design.md` | 待评审 |
| TC-C4-001..016 | 测试用例 | C4 第一切片测试设计 | 待评审 |
| C4-PROTO-001 | 低保真原型规格 | `docs/prototype/c4-first-slice-prototype-spec.md` | 待评审 |
| UI-C4-001..014 | 原型页面 | `prototype/first-slice/` | 待评审 |
